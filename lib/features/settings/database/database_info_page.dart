...
import 'package:open_words/features/settings/database/widgets/database_add/add_test_entity_tile.dart';
import 'package:open_words/features/settings/database/widgets/database_add/cubit/database_add_cubit.dart';
import 'package:open_words/features/settings/database/widgets/database_repository_test/explorer/cubit/explorer_test_cubit.dart';
import 'package:open_words/features/settings/database/widgets/database_repository_test/explorer/explorer_test_tile.dart';
import 'package:open_words/features/settings/database/widgets/database_repository_test/folder/cubit/folder_repository_test_cubit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) =>
              ExplorerTestCubit(database, GetIt.I.get())..init(),
        ),
      ],
