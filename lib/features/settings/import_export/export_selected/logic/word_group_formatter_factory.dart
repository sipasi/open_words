...
import 'package:open_words/features/settings/import_export/export_selected/logic/word_group_formatter_html.dart';
...
sealed class WordGroupFormatterFactory {
  ...
  static Future<Uint8List> format<T extends WordGroupFormatterOptions>(
    ...
    return formatter.format(groups, options: options);
  }
}
